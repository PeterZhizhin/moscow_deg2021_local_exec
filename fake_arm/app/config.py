...
REFRESH_CACHE_URLS = os.environ.get(
    "REFRESH_CACHE_URLS",
    "http://deg_ballot:8003/webhook/refresh-cache;http://deg_form:8004/webhook/refresh-cache;http://deg_componentx:8002/webhook/refresh-cache;http://blockchain_votes_processor/blockchain_connector/refresh",
)
